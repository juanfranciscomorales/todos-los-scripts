...
for( i in cant.modelos){
        ...
        resultado <- clasificaciones.test.set.ensemble.promedio.glm(test.set = "S-M test set lm.csv",cant.modelos = i, x = tabla.AUC.ordenadas.test.set, remover.NA = FALSE)
...
for( i in cant.modelos){
        ...
        resultado <- clasificaciones.test.set.ensemble.minimo.glm(test.set = "S-M test set lm.csv",cant.modelos = i, x = tabla.AUC.ordenadas.test.set, remover.NA = FALSE)
