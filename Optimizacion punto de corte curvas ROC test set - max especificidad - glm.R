optimizacion.punto.corte.ROC.test.set.max.especificidad.glm <- function (test.set = "BASE SIMULADA - Poliaminas.xlsx" , modelos = lista.modelos) { #funcion que busca el punto de corte optimo donde la especificidad es maxima
...
puntos.corte.ROC.glm <-optimizacion.punto.corte.ROC.test.set.max.especificidad.glm(test.set = "BASE SIMULADA - Poliaminas.xlsx" , modelos = lista.modelos)
