optimizacion.punto.corte.ROC.max.especificidad.glm <- function (modelos = lista.modelos) { #funcion que busca el punto de corte optimo donde la especificidad es maxima
...
puntos.corte.ROC.glm <-optimizacion.punto.corte.ROC.max.especificidad.glm(modelos = lista.modelos)
