...
resultados.y.randomization.glm <- lapply(lista.conjuntos2 , y.randomization.glm , iteraciones = 10 , punto.corte=0.05 , steps=9 , punto.corte.vif = 2)# aplico a cada conjunto la función llamada y.randomization para hacer la validacion interna y obtengo los intervalos de confianza
