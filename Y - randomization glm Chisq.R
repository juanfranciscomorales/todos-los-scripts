...
resultados.y.randomization.testChisq.glm <- lapply(lista.conjuntos2, y.randomization.testChisq.glm, iteraciones = 500,punto.corte=0.05,steps=6)# aplico a cada conjunto la función llamada y.randomization para hacer la validacion interna y obtengo los intervalos de confianza
