...
y.randomization.lm <- function ( conjunto ,iteraciones = 500,punto.corte=0.05,steps=6) {
...
resultados.y.randomization.lm <- lapply(lista.conjuntos2, y.randomization, iteraciones = 500,punto.corte=0.05,steps=6)# aplico a cada conjunto la función llamada y.randomization para hacer la validacion interna y obtengo los intervalos de confianza
