forward.stepwise.testChisq.glm.vif <- function(tabla.conjunto,punto.corte.Chi=0.01,steps=6, punto.corte.vif=2) { # funcion para realizar los modelos por glm
...
lista.modelos<- lapply(lista.conjuntos2, forward.stepwise.testChisq.glm, punto.corte.Chi=0.01,steps=6, punto.corte.vif=2)# aplico a cada conjunto la función llamada forward.stepwise.testF.glm para obtener los modelos. si quiero modifico punto de corte y numero de steps
