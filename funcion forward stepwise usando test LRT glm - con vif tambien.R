...
lista.modelos<- lapply(lista.conjuntos2, forward.stepwise.testLRT.glm.vif, punto.corte.Chi=0.01,steps=6, punto.corte.vif=2)# aplico a cada conjunto la función llamada forward.stepwise.testF.glm para obtener los modelos. si quiero modifico punto de corte y numero de steps
