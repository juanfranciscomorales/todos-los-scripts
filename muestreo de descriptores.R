...
for(i in 1:n) { 
  dflist[[i]] <- df[ , c(1,2,3,sample(k,200)) ]#hago que repita el sampleo de mi dataframe 1000 veces, tomando 200 descriptores por vez, pongo  1,2,3 xq quiero que esas columnas estén siempre
}
